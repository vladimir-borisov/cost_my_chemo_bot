...
CATEGORY_CHOOSE = (
    "Чтобы рассчитать стоимость лечения, выберите область, к которой относится заболевание. В разделе «Сопроводительная терапия» можно узнать цену некоторых дополнительных препаратов."
)
...
CUSTOM_COURSE_INPUT = (
    "Напишите название курса, который вы искали, или названия препаратов – и мы рассчитаем их стоимость."
)
...
DATA_CORRECT = dedent(
    ...
    Вы можете сохранить это сообщение, отправив его себе (нажмите на сообщение, выберите «Переслать» -> «Сохраненные»).
    Если вы хотите обсудить лечение у нас, введите в свободной форме свой телефон, почту или другой удобный способ связи, и мы свяжемся с вами в ближайшее время ...
